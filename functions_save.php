...
function onde_production_widgets_init()
{
	...
	register_sidebar(array(
		'name' => __('Footer Left', 'onde-production'),
		'id' => 'footer-left',
		'description' => ''
	));
	register_sidebar(array(
	...
	register_sidebar(array(
		'name' => __('Footer Middle', 'onde-production'),
		'id' => 'footer-middle',
		'description' => ''
	));
	register_sidebar(array(
		'name' => __('Footer right', 'onde-production'),
		'id' => 'footer-right',
		'description' => ''
	));
}
...
if (is_plugin_active( 'wp-mail-smtp/wp_mail_smtp.php')) {
     ...
     *
     * Cela est fait pour faire tourner le serveur SMTP
...
function log_mailer_errors( $wp_error ){
    $fn = ABSPATH . 'log/mail.log'; // say you've got a mail.log file in your server root
    $fp = fopen($fn, 'a');
