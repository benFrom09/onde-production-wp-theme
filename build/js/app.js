...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    key: "toggleNavigationDefault",
    value: function toggleNavigationDefault() {
      this.ui.onde_navbar.classList.remove('toggled');
      document.body.classList.remove('nav-opened');
      this.ui.onde_menu_container.setAttribute('aria-expanded', 'false');
    }
  }, {
    key: "toggleHandleClick",
    value: function toggleHandleClick() {
      ...
      if (this.state.sub_menu_opened) {
        var el = document.querySelector('#primary-menu .sub-menu');

        if (el.classList.contains('sub-menu-opened')) {
          el.classList.remove('sub-menu-opened');
          var opened = !this.state.sub_menu_opened;
          this.setState('sub_menu_opened', opened);
        }
      }
    }
  }, {
    key: "handleClickSubMenuBtn",
    value: function handleClickSubMenuBtn() {
      var _this = this;

      var btns = this.ui.onde_sub_menu_arrow_btn;

      if (btns) {
        var el = null;
        btns.forEach(function (btn) {
          btn.addEventListener('click', function (e) {
            var opened = !_this.state.sub_menu_opened;

            _this.setState('sub_menu_opened', opened);
    ...
    key: "stickyNavbar",
    value: function stickyNavbar() {
      var _this$ui = this.ui,
          onde_navbar = _this$ui.onde_navbar,
          onde_site_branding = _this$ui.onde_site_branding,
          onde_header_image = _this$ui.onde_header_image,
          onde_breakpoint_medium = _this$ui.onde_breakpoint_medium;
      var _this$state = this.state,
          navbar_rect_pos = _this$state.navbar_rect_pos,
          site_branding_rect_pos = _this$state.site_branding_rect_pos;
    ...
    key: "wcCommerceQtyBtnHandleClick",
    value: function wcCommerceQtyBtnHandleClick() {
      /*
    ...
    key: "addPlusAndMinusToQtyBtn",
    value: function addPlusAndMinusToQtyBtn(btn) {
    ...
    key: "addqty",
    value: function addqty(e) {
      e.target.previousElementSibling.value++;
      this.enableUpdateCartBtn();
    }
  }, {
    key: "soustracQty",
    value: function soustracQty(e) {
    ...
    key: "addListeners",
    value: function addListeners(elts, evt, callback) {
      elts.addEventListener(evt, callback);
    }
  }, {
    key: "enableUpdateCartBtn",
    value: function enableUpdateCartBtn() {
...
/* harmony import */ var _modules_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/animation */ "./assets/js/modules/animation.js");
/* harmony import */ var _modules_parallax_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/parallax.js */ "./assets/js/modules/parallax.js");
/* harmony import */ var _modules_Ui_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Ui.js */ "./assets/js/modules/Ui.js");
/* harmony import */ var _modules_App__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/App */ "./assets/js/modules/App.js");
/**
 * IMPORT
 */
...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    var app = new _modules_App__WEBPACK_IMPORTED_MODULE_5__["default"](_modules_Ui_js__WEBPACK_IMPORTED_MODULE_4__.Ui);
    app.init();
    app.setState('parallax_slide', (0,_modules_parallax_js__WEBPACK_IMPORTED_MODULE_3__.parallaxBackgroundSize)());
    (0,_modules_animation__WEBPACK_IMPORTED_MODULE_2__.site_branding_animation)();
    ...
    window.onresize = function (e) {
      app.update();
      (0,_modules_parallax_js__WEBPACK_IMPORTED_MODULE_3__.parallaxBackgroundSize)();
    };
  });
})();
})();
