...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'onde-production' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'onde-production' ) ) ) );
...
function customizer_library_get_google_font_uri( $fonts ) {
	...
	$subset = get_theme_mod( 'font-subset',  'all'  );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'onde-production' ),
		'cyrillic'     => __( 'Cyrillic', 'onde-production' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'onde-production' ),
		'devanagari'   => __( 'Devanagari', 'onde-production' ),
		'greek'        => __( 'Greek', 'onde-production' ),
		'greek-ext'    => __( 'Greek Extended', 'onde-production' ),
		'khmer'        => __( 'Khmer', 'onde-production' ),
		'latin'        => __( 'Latin', 'onde-production' ),
		'latin-ext'    => __( 'Latin Extended', 'onde-production' ),
		'vietnamese'   => __( 'Vietnamese', 'onde-production' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'onde-production' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'onde-production' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'onde-production' ),
