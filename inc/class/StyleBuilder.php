...
class StyleBuilder{
	...
	/**
	 * The one instance of StyleBuilder.
	 *
	 * @since 1.0.0.
	 *
	 * @var   StyleBuilder    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one StyleBuilder instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return StyleBuilder
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `StyleBuilder()->add`. Because every property value has
...
if ( ! function_exists( 'StyleBuilder' ) ) :
/**
 * Return the one StyleBuilder object.
 *
 * @since  1.0.0.
 *
 * @return StyleBuilder	The StyleBuilder object.
 */
...
//add_action( 'init', 'StyleBuilder', 1 );